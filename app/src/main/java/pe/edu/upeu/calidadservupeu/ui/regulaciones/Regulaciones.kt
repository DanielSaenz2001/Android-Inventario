package pe.edu.upeu.calidadservupeu.ui.regulaciones
...
@AndroidEntryPoint
class Regulaciones : AppCompatActivity() {

    private var mSectionsPagerAdapter: SectionsPagerAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_regulaciones)
        var colors: IntArray
            ...
            if(UtilsToken.rol_user == "Administrador"){
                if (requireArguments().getInt(ARG_SECTION_NUMBER) == 1){
                    ...
                    rootView.midView.setOnClickListener {
                        val intent = Intent(this.requireContext(), RegulacionesList::class.java)
                        intent.putExtra(RegulacionesList.tipo,"prima")
                ...
                if (requireArguments().getInt(ARG_SECTION_NUMBER) == 2){
                    ...
                    rootView.midView.setOnClickListener {
                        val intent = Intent(this.requireContext(), RegulacionesList::class.java)
                        intent.putExtra(RegulacionesList.tipo,"empaque")
                        startActivity(intent)
                    }
                }
                if (requireArguments().getInt(ARG_SECTION_NUMBER) == 3){
                    ...
                    rootView.midView.setOnClickListener {
                        val intent = Intent(this.requireContext(), RegulacionesList::class.java)
                        intent.putExtra(RegulacionesList.tipo,"producto")
                        startActivity(intent)
                    }
